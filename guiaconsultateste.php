...
if(isset($_POST['botao']) && $_POST['botao']=='Salvar')
{
	try 
	{
		...
		$_SESSION['dados']['DT_VALIDADE_CARTEIRA'] = $_POST['validadeCarteira'];
...
<div id="guiaConsulta" style="height:1300px;" class="form-group" >
	<form id="login" name="login" method="post" onSubmit="return validate('');" autocomplete="off" action="index.php?pagina=guiaconsultateste"> 
		<div id="node1" >
