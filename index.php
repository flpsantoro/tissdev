...
if (isset($_SESSION['logado'])) {
	...
	switch ($pagina) {
		...
		case 'gridguia_fabio':        require_once 'gridguias_fabio.php';    	break;
		case 'gridguia':      		  require_once 'gridguias.php';    			break;
		case 'autorizacao_consulta':  require_once 'autorizacao_consulta.php';	break;
		case 'redirect':              require_once 'redirect.php';	            break;
		default:
