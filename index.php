...
<div id="layout">
    ...
    <div id="conteudo">
        ...
        if (isset($_SESSION['logado'])) {
            ...
            switch ($pagina) {
                case 'mudar_senha':
                    require_once 'mudar_senha.php';
                    break;
                case 'recebimento':
                    require_once 'recebimento.php';
                    break;
                case 'elegibilidade':
                    require_once 'elegibilidade.php';
                    break;
                case 'upload':
                ...
                case 'guiaconsulta_fabio':
                    require_once 'guiaconsulta_fabio.php';
                    break;
                case 'guiaconsultateste':
                    require_once 'guiaconsultateste.php';
                    break;
                case 'gridguia_fabio':
                    require_once 'gridguias_fabio.php';
                    break;
                case 'gridguia':
                    require_once 'gridguias.php';
                    break;
                case 'autorizacao_consulta':
                    require_once 'autorizacao_consulta.php';
                    break;
                case 'redirect':
